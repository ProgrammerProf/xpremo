...
export default function Page () {
    ...
    const details = {
        ...
        details: "الشاشة: يأتي iPhone 13 Pro Max بشاشة Super Retina XDR OLED بحجم 6.7 بوصة. تتميز الشاشة بدقة عالية وألوان غنية وسطوع ممتاز. الأداء: يعتمد iPhone 13 Pro Max على شريحة A15 Bionic، وهي شريحة معالجة قوية توفر أداءً متفوقًا وكفاءة طاقة محسّنة. تتيح هذه الشريحة القدرة على تشغيل التطبيقات والألعاب الثقيلة بسلاسة.",
        count: "9",
        rate: 5,
        images: [
    ...
    const products = [
        ...
        },
        {
            ...
            new_price: "1200",
            old_price: "3000",
            image: "/media/product/9.png",
            image_hover: "/media/product/10.png",
            company: "ايفون",
            type: "جديد",
            description: "الشاشة: يأتي iPhone 13 Pro Max بشاشة Super Retina XDR OLED بحجم 6.7 بوصة. تتميز الشاشة بدقة عالية وألوان غنية وسطوع ممتاز. الأداء: يعتمد iPhone 13 Pro Max على شريحة A15 Bionic، وهي شريحة معالجة قوية توفر أداءً متفوقًا وكفاءة طاقة محسّنة. تتيح هذه الشريحة القدرة على تشغيل التطبيقات والألعاب الثقيلة بسلاسة.",
            count: "9",
    ...
    return <Product data={details} products={products} />
