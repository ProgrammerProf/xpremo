...
export default function FavouriteHomeIcon({ className }) {

    return (

        <svg className="bi bi-house-heart-fill fill-[--main-color] mt-[-3px]" height="33" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
